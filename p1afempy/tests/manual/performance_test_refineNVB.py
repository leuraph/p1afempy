...
def main() -> None:
    ...
    path_to_matlab_means = Path(
        ...
        'newest_vertex_bisection/means.dat')
    path_to_matlab_stdevs = Path(
        'tests/data/matlab_performance/'
        'newest_vertex_bisection/stdevs.dat')
    path_to_matlab_n_elements = Path(
        'tests/data/matlab_performance/'
        'newest_vertex_bisection/n_elements.dat')
    ...
    fig, ax = plt.subplots()
    ax.set_title('P1AFEM(PY): newest vertex bisection')
    ...
    ax.set_xlabel('number of elements refined')
    ...
    ax.grid()
    ax.legend(loc='best')
    fig.savefig('newest_vertex_bisection.png')
